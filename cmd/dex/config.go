...
type OAuth2 struct {
	...
	// Password connectors that can support OAuth2 resource owner password
	// credential grant types require a connector ID
	PasswordConnectorID string `json:"passwordConnectorID"`
}
